...
Clear - не должен удалять память 
Resize - должен не только уменьшать, но и увеличивать размер Insert, 
Erase - не должны принимать переменное количество аргументов. 
НЕ СОЗДАВАТЬ СТАТИЧЕСКИЕ МАССИВЫ С РАЗМЕРОМ КАПАСИТИ
 */
