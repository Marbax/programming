...
vector::resize Изменяет размер вектора на заданную величину +-
    */
    ...
    void Resize(int new_size) // Изменяет размер вектора на заданную величину !!ПРОВЕРИТЬ!!
    {
        if (new_size >= 0)
        {
            if (size)
    ...
    void Insert(int pos, int val) //Вставка элемента(одного) в вектор !!ПРОВЕРИТЬ!!
    {
        if (pos < size && pos >= 0)
        {
            //++size;
    ...
    void Insert(int pos, int count, ...) //Вставка элементов в вектор !!ПРОВЕРИТЬ!!
    {
        if (size)
        {
    ...
    void Erase(int count, ...) //  Удаляем указанные элементы вектора (несколько) !!ПРОВЕРИТЬ!!
    {
        if (size)
        {
            size_t size_dif = 0;
    ...
    void Erase(int val) //  Удаляем указанные элементы вектора (один) !!ПРОВЕРИТЬ!!
    {
        if (size)
        {
            size_t size_dif = 0;
    ...
    void Pop_back() // Удалить последний элемент вектора !!ПРОВЕРИТЬ!!
    {
        if (size)
        {
            arr[size] = 0;
