...
### r-value ссылки , ссылаются на временные обьекты , даже на литералы
...
По умолчанию большинство операторов работают со стандартными типами
...
Глобальные перегрузки и дружественные перегрузки , глобальная не имеет доступа к приватной части класса, дружественные ф-и (нарушают инкапсуляцию ПЛОХО) имеют доступ к приватной части класса б можно описовать в классе или оставлять ее хедер ,она не будет частью класса все равно (может быть дружественный класс).
